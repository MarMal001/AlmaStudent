<main>
    <section>
        ...
        <select name="courses" id="degreeCode" onchange="getProfessorsData()">
    ...
    <section class="m-2" id="professors">
        <?php foreach ($dbh->getProfessors() as $professor): ?>
            <div class="container-fluid w-auto w-lg-55 m-2 p-0">
                ...
                <div class="d-md-inline-flex align-items-md-center p-0">
                    ...
                    <div>
                        <?php createStars(getMeanRating([$professor["ratingD"], $professor["ratingC"], $professor["ratingD"]]), "rgb(30, 48, 80)"); ?>
                    </div>
                </div>
                ...
                <div id="<?php echo $professor["professor"]; ?>" class="collapse p-3 w-100 border border-primary border-2 rounded">
                    ...
                    <ul class="d-flex flex-column align-items-start">
                        <?php foreach ($dbh->getCoursesByProfessor($professor["professor"]) as $course): ?>
